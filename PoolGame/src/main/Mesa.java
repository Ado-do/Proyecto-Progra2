...
public class Mesa extends JPanel {
    ...
    public Mesa(int x, int y, int width, int length) {
        ...
        this.addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                posMouse = e.getPoint().getLocation();
    ...
    public void paintComponent(Graphics g) {
        ...
        if (Angular.distEntre2Puntos(posMouse.getLocation(), blanca.getLocation()) <= (Bola.RADIUS + Taco.DISTANCE + Taco.LENGTH)) {
            ...
            //! Dibujar taco
            taco.sendMousePos(posMouse);
            taco.paint(g2D);
            
            //? Generar circulo que se mueve según mouse alrededor de bola blanca
            float angle = Angular.anguloPI(blanca.getLocation(), posMouse.getLocation()); //* Calcular angulo que se forma entre posición de mouse y el centro de la bola blanca
